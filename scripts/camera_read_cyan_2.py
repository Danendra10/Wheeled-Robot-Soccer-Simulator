...
pub = rospy.Publisher('cyan2/vision_ball_sim', Char, queue_size=10)


class camera_1:

  def __init__(self):
    self.image_sub = rospy.Subscriber("cyan2/omni_cam/omni_image_raw", Image, self.callbackData)
